...
do
    ...
    local function BuildSliderPiece(Parent, OuterSize, Info)
        ...
        local DropdownLabel = Library:CreateLabel({ Size=UDim2.new(1,0,1,0); TextSize=(11); Text=''; ZIndex=9; Parent=SInner })
        ...
        function Slider:Display()
            ...
            local raw = Library:ApplyCase(Slider.Info.Text or "", "Sliders")..': '..Slider.Value..suf
            DropdownLabel.Text = raw:gsub(".", "%1\226\128\138")
